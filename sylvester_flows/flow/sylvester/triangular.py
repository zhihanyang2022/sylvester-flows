...
class UnconditionalTriangularSylvesterFlow(AbstractFlow):
    ...
    def __init__(self, D, K):
        ...
        odd_indices = torch.arange(1, self.K, 2)
        self.Q = torch.eye(self.D, self.D).reshape(1, 1, self.D, self.D).repeat(1, self.K, 1, 1)
        self.Q[0, odd_indices] = self.Q[0, odd_indices][0, :, torch.arange(self.D - 1, -1, -1)]
