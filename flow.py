...
class UnconditionalOrthogonalFlow(nn.Module):
    ...
    @property
    def Q(self):
        return linalg.batch_construct_orthogonal(self.pre_Q)
    ...
    def sample_and_compute_logp(self, num_samples):
        samples, log_probs = core.batch_sample_from_sylvester_flow(
